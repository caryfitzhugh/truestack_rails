...
window.onload = function() {
  ...
  newimg.setAttribute("src","#{img_url}&tstart="+_truestack_browser_data.tstart.getTime() / 1000.0+"&tloaded="+_truestack_browser_data.tloaded.getTime() / 1000.0+"&tready="+_truestack_browser_data.tready.getTime() / 1000.0);
